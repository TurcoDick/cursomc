package com.alison.cursomc.resources.exception;
...
import com.alison.cursomc.services.exceptions.FileException;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> objectNotFound(ObjectNotFoundException e, 
		...
		StandardError err = new StandardError(System.currentTimeMillis(), HttpStatus.NOT_FOUND.value(), "Not found. Não encontrado",
	...
	public ResponseEntity<StandardError> dataIntegrity(DataIntegrityException e, 
		...
		StandardError err = new StandardError(System.currentTimeMillis(), HttpStatus.BAD_REQUEST.value(), "Integrated data. Integridade de dados",
				e.getMessage(), request.getRequestURI());
